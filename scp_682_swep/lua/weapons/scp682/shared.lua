...
if tgt.HitPos:Distance(self.Owner:GetShootPos()) <= 190 then  -- 190 is the distance away the swep can hit. Taking into account of the player model
...
function SWEP:OnDrop()
	...
	self:Remove() -- You can't drop this swep
